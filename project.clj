(defproject rm-hull/mastermind "0.0.1-SNAPSHOT"
  :clojurescript? true
  :description "A Clojure/Clojurescript mastermind game"
  :source-paths ["src"]
  :url "https://github.com/rm-hull/mastermind"
  :license {:name "The MIT License (MIT)"
            :url "http://opensource.org/licenses/MIT"}
  :scm {:url "git@github.com:rm-hull/mastermind"}
